...
curl -o "C:\Users\Public\Desktop\vc_redist.x64.exe" https://download.microsoft.com/download/9/3/F/93FCF1E7-E6A4-478B-96E7-D4B285925B00/vc_redist.x64.exe > out.txt 2>&1
